...
<link rel="stylesheet" type="text/css" href="http://endoscopy21.ru/css/style.css">
<?php 
if ($current_page == '/administration'){
  echo "<link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro' rel='stylesheet' type='text/css'>";
  echo "<link rel='stylesheet' type='text/css' href='http://endoscopy21.ru/css/registry_style.css'>";
} else {
   echo "<link rel='stylesheet' type='text/css' href='user-style.css'>";   
}
?>
...
<body>
  ...
  <header style='text-align: center'>
    <img src='logo64.png' align='center'><h1 id='logo'><br/><a class='logo_href' href='http://endoscopy21.ru/'>ЭНДОСКОПИЧЕСКИЙ ЦЕНТР</a></h1>
