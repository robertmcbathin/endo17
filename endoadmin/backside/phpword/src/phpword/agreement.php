 <?php include_once 'none-header.php';?>
  <section id="immagine">
  <div class="row" style="max-width:1920px;">
    <div id="documents">
    <?php
      echo "<h2>ДОГОВОРЫ</h2>";
      $dir = opendir("agreements");
      while (($agreement_in_list = readdir($dir)) !== FALSE) echo "<a href='agreements/$agreement_in_list'>$agreement_in_list</a><br>";
      closedir($dir);
      echo "<h2>АКТЫ</h2>";
      $dir = opendir("acts");
      while (($act_in_list = readdir($dir)) !== FALSE) echo "<a href='acts/$act_in_list'>$act_in_list</a><br>";
      closedir($dir);
    ?>
    </div>
    <div class="center">
    ...
    //     $objWriter = \PhpOffice\PhpWord\IOFactory::createWriter($phpWord, 'Word2007');
      //   $objWriter->save('agreements/agreement_name3.docx');
        ...
        <h3>Информация о пациенте</h3>
          ...
          <input type="text" class="pw" maxlength="15" name="id" placeholder="Номер договора" size="15" value="<?php echo $id;?>">
          <input type="text" class="pw" maxlength="50" name="pacient_name" placeholder="ФИО пациента" size="50" value="<?php echo $pacient_name;?>">
          <h4>Паспортные данные</h3>
          <label for="passport_serie">серия: <input type="text" class="pw" maxlength="4" name="passport_serie" id="passport_serie" placeholder="0000" size="4" value="<?php echo $passport_serie;?>"></label>
          <label for="passport_number">номер: <input type="text" class="pw" maxlength="6" name="passport_number"  placeholder="000000" size="6" value="<?php echo $passport_number;?>"></label>
          <label for="passport_issued_date">кем и когда выдан: <input type="text" class="pw" maxlength="150" name="passport_issued_date"  placeholder="Место и дата выдачи паспорта" size="150" value="<?php echo $passport_issued_date;?>"></label>
          <h4>Контактные данные</h3>
          <input type="text" class="pw" maxlength="100" name="residential_address" placeholder="Место фактического проживания" size="100" value="<?php echo $residential_address;?>">
          <input type="text" class="pw" maxlength="20" name="phone" placeholder="Контактный телефон" size="20" value="<?php echo $phone;?>">
          <h3>Информация о предоставленных услугах</h3>
          <div id="services">
           <h4>Услуга 1</h4>
            <input list="service-name" name="service1" id="list" placeholder="Выберите наименование услуги из выпадающего списка" size="100" type="text" value="<?php echo $service1;?>"/>
            ...
            <input type="text" name =      "q1" id =      "q1" placeholder="Количество" size="5" value="<?php      echo $q1;?>"/>
            <input type="text" name =  "price1" id =  "price1" placeholder="Цена" size="6" value="<?php        echo $price1;?>"/>
            <input type="text" name = "doctor1" id = "doctor1" placeholder="ФИО врача" size="50" value="<?php echo $doctor1;?>"/>
            <hr>
           <h4>Услуга 2</h4>
            <input list="service-name" name="service2" id="list" placeholder="Выберите наименование услуги из выпадающего списка" size="100" type="text" value="<?php echo $service2;?>"/>
            <datalist id="service-name">
              <option value="Трансназальная видегастроскопия К.М.Н."></option>
              <option value="Трансназальная видегастроскопия"></option>
              <option value="Фиброгастроскопия"></option>
            ...
            <input type="text" name =      "q2" id =      "q2" placeholder="Количество" size="5" value="<?php      echo $q2;?>"/>
            <input type="text" name =  "price2" id =  "price2" placeholder="Цена" size="6" value="<?php        echo $price2;?>"/>
            <input type="text" name = "doctor2" id = "doctor2" placeholder="ФИО врача" size="50" value="<?php echo $doctor2;?>"/>
            <hr>
           <h4>Услуга 3</h4>
            <input list="service-name" name="service3" id="list" placeholder="Выберите наименование услуги из выпадающего списка" size="100" type="text" value="<?php echo $service3;?>"/>
            <datalist id="service-name">
              <option value="Трансназальная видегастроскопия К.М.Н."></option>
              <option value="Трансназальная видегастроскопия"></option>
              <option value="Фиброгастроскопия"></option>
            ...
            <input type="text" name =      "q3" id =      "q3" placeholder="Количество" size="5" value="<?php      echo $q3;?>"/>
            <input type="text" name =  "price3" id =  "price3" placeholder="Цена" size="6" value="<?php        echo $price3;?>"/>
            <input type="text" name = "doctor3" id = "doctor3" placeholder="ФИО врача" size="50" value="<?php echo $doctor3;?>"/>
            <hr>
           <h4>Услуга 4</h4>
            <input list="service-name" name="service4" id="list" placeholder="Выберите наименование услуги из выпадающего списка" size="100" type="text" value="<?php echo $service4;?>"/>
            <datalist id="service-name">
              <option value="Трансназальная видегастроскопия К.М.Н."></option>
              <option value="Трансназальная видегастроскопия"></option>
              <option value="Фиброгастроскопия"></option>
            ...
            <input type="text" name =      "q4" id =      "q4" placeholder="Количество" size="5" value="<?php      echo $q4;?>"/>
            <input type="text" name =  "price4" id =  "price4" placeholder="Цена" size="6" value="<?php        echo $price4;?>"/>
            <input type="text" name = "doctor4" id = "doctor4" placeholder="ФИО врача" size="50" value="<?php echo $doctor4;?>"/>
            <hr>
           <h4>Услуга 5</h4>
            <input list="service-name" name="service5" id="list" placeholder="Выберите наименование услуги из выпадающего списка" size="100" type="text" value="<?php echo $service5;?>"/>
            <datalist id="service-name">
              <option value="Трансназальная видегастроскопия К.М.Н."></option>
              <option value="Трансназальная видегастроскопия"></option>
              <option value="Фиброгастроскопия"></option>
            ...
            <input type="text" name =      "q5" id =      "q5" placeholder="Количество" size="5" value="<?php      echo $q5;?>"/>
            <input type="text" name =  "price5" id =  "price5" placeholder="Цена" size="6" value="<?php        echo $price5;?>"/>
            <input type="text" name = "doctor5" id = "doctor5" placeholder="ФИО врача" size="50" value="<?php echo $doctor5;?>"/>
            <hr>
           <h4>Услуга 6</h4>
            <input list="service-name" name="service6" id="list" placeholder="Выберите наименование услуги из выпадающего списка" size="100" type="text" value="<?php echo $service6;?>"/>
            <datalist id="service-name">
              <option value="Трансназальная видегастроскопия К.М.Н."></option>
              <option value="Трансназальная видегастроскопия"></option>
              <option value="Фиброгастроскопия"></option>
            ...
            <input type="text" name =      "q6" id =      "q6" placeholder="Количество" size="5" value="<?php      echo $q6;?>"/>
            <input type="text" name =  "price6" id =  "price6" placeholder="Цена" size="6" value="<?php        echo $price6;?>"/>
            <input type="text" name = "doctor6" id = "doctor6" placeholder="ФИО врача" size="50" value="<?php echo $doctor6;?>"/>
            <hr>
          </div>
          <input type="text" name ="signed_person" id ="signed_person" placeholder="ФИО врача или медицинской сестры/лаборанта" size="100" value="<?php echo $signed_person;?>"/>
          <input type="submit" class="button" id="submit_agreement"  value="Сохранить в файл" name="submit-service">
        </form>
	  </div>
    </div>
  </div>
